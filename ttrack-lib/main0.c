...
stderr
# 11 "src/dbg.c"
, "assertion failed at " "__func__" " (" "__FILE__" " " "__LINE__" ")\n" "expression: " "stream != ((void *)0)" "\n" ); stacktrace_print(
# 11 "src/dbg.c" 3 4
stderr
# 11 "src/dbg.c"
); 
...
"0"
# 11 "src/dbg.c" 3 4
, "src/dbg.c", 11, __extension__ __PRETTY_FUNCTION__); }))
# 11 "src/dbg.c"
; } } while(0);
 do { if(!(ferror(stream) == 0)) { fprintf(
# 12 "src/dbg.c" 3 4
stderr
# 12 "src/dbg.c"
, "assertion failed at " "__func__" " (" "__FILE__" " " "__LINE__" ")\n" "expression: " "ferror(stream) == 0" "\n" ); stacktrace_print(
# 12 "src/dbg.c" 3 4
stderr
# 12 "src/dbg.c"
); 
...
"0"
# 12 "src/dbg.c" 3 4
, "src/dbg.c", 12, __extension__ __PRETTY_FUNCTION__); }))
# 12 "src/dbg.c"
; } } while(0);
 do { if(!(head_format != 
# 13 "src/dbg.c" 3 4
...
"0"
# 13 "src/dbg.c" 3 4
, "src/dbg.c", 13, __extension__ __PRETTY_FUNCTION__); }))
# 13 "src/dbg.c"
; } } while(0);
 do { if(!(body_format != 
# 14 "src/dbg.c" 3 4
...
"0"
# 14 "src/dbg.c" 3 4
, "src/dbg.c", 14, __extension__ __PRETTY_FUNCTION__); }))
# 14 "src/dbg.c"
; } } while(0);
 do { if(!(strstr(head_format, "%s") <= strstr(head_format, "%i"))) { fprintf(
# 15 "src/dbg.c" 3 4
stderr
# 15 "src/dbg.c"
, "assertion failed at " "__func__" " (" "__FILE__" " " "__LINE__" ")\n" "expression: " "strstr(head_format, \"%s\") <= strstr(head_format, \"%i\")" "\n" ); stacktrace_print(
# 15 "src/dbg.c" 3 4
stderr
# 15 "src/dbg.c"
); 
...
"0"
# 15 "src/dbg.c" 3 4
, "src/dbg.c", 15, __extension__ __PRETTY_FUNCTION__); }))
# 15 "src/dbg.c"
; } } while(0);
...
# 51 "src/dbg.c"
                      ;
 int ret = vsnprintf(buf, (1024 * 4), format, args);
...
# 53 "src/dbg.c"
 ...
 size_t bufsize = ret < 0 ? (1024 * 4) : (size_t)ret;
...
# 67 "src/dbg.c"
  ...
  memset(nlbuf, '\t', 10);
  fwrite(nlbuf, sizeof(char), 10, DUMP_STREAM);
  fputs("...\n", DUMP_STREAM);
 }
}
...
"0"
# 91 "src/dbg.c" 3 4
, "src/dbg.c", 91, __extension__ __PRETTY_FUNCTION__); }))
# 91 "src/dbg.c"
; } } while(0);
 do { if(!(funcname != 
# 92 "src/dbg.c" 3 4
...
"0"
# 92 "src/dbg.c" 3 4
, "src/dbg.c", 92, __extension__ __PRETTY_FUNCTION__); }))
# 92 "src/dbg.c"
; } } while(0);
 do { if(!(filename != 
# 93 "src/dbg.c" 3 4
...
"0"
# 93 "src/dbg.c" 3 4
, "src/dbg.c", 93, __extension__ __PRETTY_FUNCTION__); }))
# 93 "src/dbg.c"
; } } while(0);
...
static stacktrace_t stacktrace = { 
# 118 "src/dbg.c" 3 4
                                  ((void *)0)
# 118 "src/dbg.c"
                                      , 0, 0 };
...
"0"
# 123 "src/dbg.c" 3 4
, "src/dbg.c", 123, __extension__ __PRETTY_FUNCTION__); }))
# 123 "src/dbg.c"
; } } while(0);
 do { if(!(filename != 
# 124 "src/dbg.c" 3 4
...
"0"
# 124 "src/dbg.c" 3 4
, "src/dbg.c", 124, __extension__ __PRETTY_FUNCTION__); }))
# 124 "src/dbg.c"
; } } while(0);
...
# 127 "src/dbg.c"
  ...
  frame__init(frame, stacktrace.last == 
# 131 "src/dbg.c" 3 4
                                       ((void *)0) 
# 131 "src/dbg.c"
                                            ? 
...
void stacktrace__pop() {
 do { if(!(stacktrace.depth != 0)) { fprintf(
# 139 "src/dbg.c" 3 4
stderr
# 139 "src/dbg.c"
, "assertion failed at " "__func__" " (" "__FILE__" " " "__LINE__" ")\n" "expression: " "stacktrace.depth != 0" "\n" ); stacktrace_print(
# 139 "src/dbg.c" 3 4
stderr
# 139 "src/dbg.c"
); 
...
"0"
# 139 "src/dbg.c" 3 4
, "src/dbg.c", 139, __extension__ __PRETTY_FUNCTION__); }))
# 139 "src/dbg.c"
; } } while(0);
...
"stream != NULL"
# 178 "src/dbg.c" 3 4
, "src/dbg.c", 178, __extension__ __PRETTY_FUNCTION__); }))
# 178 "src/dbg.c"
; 
# 178 "src/dbg.c" 3 4
((void) sizeof ((
...
ferror(stream) == 0
# 178 "src/dbg.c" 3 4
) ; else __assert_fail ("ferror(stream) == 0", "src/dbg.c", 178, __extension__ __PRETTY_FUNCTION__); }))
# 178 "src/dbg.c"
; } while(0);
 ...
 for(size_t i = 0; i < stacktrace.ninvframes; ++i) {
  fprintf(stream, "\t[INVALID FRAME], called from\n");
 }
...
# 188 "src/dbg.c"
   ...
   fprintf(stream, "\t %s (%s %zu), called from\n", frame->func, frame->file,
     frame->line);
  }
  else {
